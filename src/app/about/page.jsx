...
<section className="w-full py-15 bg-[#35908D]">
  <div className="container">
    <div className="md:hidden flex flex-col gap-6 rounded-[24px] p-6"  style={{ border: "1px solid #20B2AA30", boxShadow: "0px 2px 12px 0px #FFFFFF40 inset, 0px 1px 3px 0px #1A1A1A0A, 0px 6px 6px 0px #E5F3F208, 0px 13px 8px 0px #9EFFEE05, 0px 22px 9px 0px #9EFFEE03, 0px 35px 10px 0px #C9F9FF00"}}>
      ...
      <p className="!text-[#9E2016] text-[18px] font-semibold uppercase opacity-80">{founder.label}</p>
      <h3 className="!text-white font-semibold" style={{ fontSize: "32px" }}>{founder.title}</h3>
      {founder.paragraphs.map((para, i) => (
        <p key={i} className="text-white text-[18px] leading-relaxed opacity-90 italic">{para} </p>))}
      <div>
        <p className="text-white font-semibold text-[18px] mb-2">{founder.name}</p>
    ...
    <div className="hidden md:flex items-center gap-6 lg:gap-10 rounded-[24px] p-6 lg:p-[40px]" style={{ border: "1px solid rgba(32, 178, 170, 0.19)", boxShadow: "0px 2px 12px 0px rgba(255,255,255,0.25) inset" }}>
      ...
      <div className="flex flex-col gap-4 lg:gap-6 flex-1 min-w-0 lg:pt-[46px] lg:pb-[6px]">
        <p className="text-[#9E2016] text-[18px] font-semibold uppercase opacity-80">{founder.label}</p>
        <h3 className="!text-white font-semibold text-lg lg:!text-[40px] whitespace-nowrap md:whitespace-normal xl:whitespace-nowrap"> {founder.title}</h3>
        {founder.paragraphs.map((para, i) => (
          <p key={i} className="text-white lg:text-[18px] leading-relaxed opacity-90 italic"> {para} </p>
        ))}
        <div>
          <p className="text-white font-semibold lg:text-[18px]">{founder.name}</p>
          <p className="text-md" style={{ color: "#A5E7F0" }}>{founder.designation}</p>
        </div>
      </div>
    </div>
...
<ShapeDental
  ...
  images={["/assets/instituition.webp", "/assets/admission-banner.webp", "/assets/facilities-banner.webp"]}
