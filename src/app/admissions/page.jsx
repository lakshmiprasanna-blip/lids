...
/>
 ...
 <section className="relative bg-white py-10 overflow-hidden">
      <div className="absolute pointer-events-none rounded-full" style={{ width: "600px", height: "600px", top: "-100px", right: "-200px", background: "rgba(207,239,237,0.4)", filter: "blur(120px)", zIndex: 0 }} />
      ...
      <div className="relative z-10 container">
        ...
        <div className="text-center mb-12">
          ...
          <p className="mt-4 text-[#333333] text-base max-w-5xl mx-auto">
  ...
  <div className="flex items-center gap-1 rounded-full p-2" style={{ background: "#F5F5F5", border: "1px solid #E0E0E0" }}>
    {tabs.map((tab) => (
      <button key={tab} onClick={() => setActive(tab)}
        className="whitespace-nowrap px-4 py-2 rounded-full text- font-medium transition-all duration-300"
...
<div className="flex flex-col gap-6">
  {content[active].map((item, i) => (
    <div key={i} className="flex items-start gap-3">
      ...
      <p className="text-[#3D3D3D] text-[18px] leading-relaxed text-left">
