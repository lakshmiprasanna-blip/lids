...
export default function AlumniStories({
  ...
  return (
      ...
      <div className="md:hidden flex flex-col gap-6 px-5">
        <div className="flex flex-col justify-between p-6 rounded-[24px]" style={{  minHeight: "280px",  border: "1px solid #A5E7F07A", 
...
<div key={i} className="group flex flex-col justify-center p-10 rounded-[24px] shrink-0 bg-[#FFFFFF1A] hover:bg-[#9EFFEE1F] transition-colors duration-300" style={{ 
  width: "708px", 
  minHeight: "322px", 
